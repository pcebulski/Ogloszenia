...
public class MetodaCSVwindows {
	private static final String SEPARATOR = ";";

	
	public static void zapiszOgloszenia(File plik,  List<OgloszeniaCSV> lista) throws UnsupportedEncodingException  {
		try(PrintWriter out = new PrintWriter(plik, "windows-1250")){
